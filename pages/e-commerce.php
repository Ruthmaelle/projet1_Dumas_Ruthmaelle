      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            <h1>Bienvenue</h1>
            <p class="opacity-75">Venez nous rejoindre</p>
            <a class="btn btn-lg btn-primary" href="../Authentification/signUp.php">Sign up today</a>
            <a class="btn btn-lg btn-primary" href="../Authentification/login.php">Login today</a>
          </div>
        </div>
      </div>
  ...
  <g id="i-define-a-black-ring-yellow" fill="#img10"  transform="translate(20.000000, 20.000000)">
    <g id="Group">
      ...
      <image x="146" y="14" width="50" height="35"
        ...
        <h2 class="fw-normal">HairCare</h2>
        <p>Invest in your hair. It is the crown you never take</p>
